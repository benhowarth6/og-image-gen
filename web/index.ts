...
const imageLightOptions: DropdownOption[] = [
    { text: 'Vercel', value: 'https://db.ipatchrepairs.co.uk/logo-solo.svg' },
    { text: 'Next.js', value: 'https://db.ipatchrepairs.co.uk/logo-solo.svg' },
    { text: 'Hyper', value: 'https://db.ipatchrepairs.co.uk/logo-solo.svg' },
];

const imageDarkOptions: DropdownOption[] = [

    { text: 'Vercel', value: 'https://db.ipatchrepairs.co.uk/logo-solo.svgg' },
    { text: 'Next.js', value: 'https://db.ipatchrepairs.co.uk/logo-solo.svg' },
    { text: 'Hyper', value: 'https://db.ipatchrepairs.co.uk/logo-solo.svg' },
];
